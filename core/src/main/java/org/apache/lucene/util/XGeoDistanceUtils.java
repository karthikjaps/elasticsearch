 ...
 * @lucene.experimental
 */
public class XGeoDistanceUtils {
  ...
  public static final double vincentyDistance(final double lonA, final double latA, final double lonB, final double latB) {
    ...
    final double oF = 1 - XGeoProjectionUtils.FLATTENING;
    ...
    do {
      ...
      c = XGeoProjectionUtils.FLATTENING/16 * cos2Alpha * (4 + XGeoProjectionUtils.FLATTENING * (4 - 3 * cos2Alpha));
      lambdaP = lambda;
      lambda = L + (1 - c) * XGeoProjectionUtils.FLATTENING * sinAlpha * (sigma + c * sinSigma * (cos2SigmaM + c * cosSigma *
    ...
    final double uSq = cos2Alpha * (XGeoProjectionUtils.SEMIMAJOR_AXIS2 - XGeoProjectionUtils.SEMIMINOR_AXIS2) / (XGeoProjectionUtils.SEMIMINOR_AXIS2);
    ...
    return (XGeoProjectionUtils.SEMIMINOR_AXIS * A * (sigma - deltaSigma));
  }
